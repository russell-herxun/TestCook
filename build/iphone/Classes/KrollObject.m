 ...
 * Copyright (c) 2009-2011 by TestCook, Inc. All Rights Reserved.
...
//@interface TestCookObject : NSObject
//@end

@interface TestCookObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TestCookObject class]])
		{
			for (NSString *key in [[(TestCookObject*)o modules] allKeys])
			{
