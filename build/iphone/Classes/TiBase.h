...
// in simulator we redefine to format for TestCook Developer console
...
{\
	NSString * exceptionName = [@"org.testcook." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testcook";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITestCookNativeItemNone = -1, 
	UITestCookNativeItemSpinner = -2,
	UITestCookNativeItemProgressBar = -3,
	
	UITestCookNativeItemSlider = -4,
	UITestCookNativeItemSwitch = -5,
	UITestCookNativeItemMultiButton = -6,
	UITestCookNativeItemSegmented = -7,
	
	UITestCookNativeItemTextView = -8,
	UITestCookNativeItemTextField = -9,
	UITestCookNativeItemSearchBar = -10,
	
	UITestCookNativeItemPicker = -11,
	UITestCookNativeItemDatePicker = -12,
	
	UITestCookNativeItemInfoLight = -13,
	UITestCookNativeItemInfoDark = -14,
	
	UITestCookNativeItemDisclosure = -15,
	
	UITestCookNativeItemContactAdd = -16
};
